...
<html lang="pt-br" ng-app="app">
    <head>
        ...
        <script type="text/javascript" src="./resources/js/categoriaConta/controller.js"></script>
        <script type="text/javascript" src="./resources/js/categoriaConta/service.js"></script>

        <script type="text/javascript" src="./resources/js/tipoConta/controller.js"></script>
        <script type="text/javascript" src="./resources/js/tipoConta/service.js"></script>

        <script type="text/javascript" src="./resources/js/conta/controller.js"></script>
        <script type="text/javascript" src="./resources/js/categoriaConta/service.js"></script>
        ...
        <script type="text/javascript" src="./resources/js/itemAcesso/controller.js" ></script>
        <script type="text/javascript" src="./resources/js/itemAcesso/service.js" ></script>

        <script type="text/javascript" src="./resources/js/perfilacesso/controller.js" ></script>
        <script type="text/javascript" src="./resources/js/perfilacesso/service.js" ></script>

        <script type="text/javascript" src="./resources/js/perfilItemAcesso/controller.js" ></script>
        <script type="text/javascript" src="./resources/js/perfilItemAcesso/service.js" ></script>
            ...
            <div class="page-sidebar" id="main-menu">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li><a href="#/contasAPagar">Contas a pagar</a></li>
                            <li><a href="#/contasAReceber">Contas a receber</a></li>
                            <li><a href="#/tiposDeContas">Tipos de conta</a></li>
                            <li><a href="#/categoriasDeContas">Categorias de conta</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">
