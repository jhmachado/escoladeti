...
//            console.log(movimento);
                    ...
                    $scope.pessoas.forEach(function(pessoaOrigem) {
                        if (pessoaOrigem.id === $scope.movimento.pessoas.id) {
                            $scope.movimento.pessoas = pessoaOrigem.id;
                        }
                    });
                });
...
//        $scope.movimento.quantidade = $scope.movimento.quantidade;
        ...
        $scope.pessoas.forEach(function(pessoaOrigem) {
            if (pessoaOrigem.id == $scope.movimento.pessoaOrigem) {
                $scope.movimento.pessoas = pessoaOrigem;
            }
        });
...
//            console.log('erro ao buscar movimento ' + data);
    ...
    $http.get('./rest/pessoas/todasPessoas/')
            .success(function(pessoas, status) {
                console.log(pessoas);
                $scope.pessoas = pessoas;
            })
            .error(function(data, status) {
//        console.log("erro ao carregar pessoas" + data);
            });
